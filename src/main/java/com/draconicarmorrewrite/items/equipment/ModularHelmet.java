...
public class ModularHelmet extends ArmorItem implements IModularArmor, IDEEquipment, EquippedModelItem {
    private final TechLevel techLevel;

    public ModularHelmet(TechProperties props) {
        super(ModularArmorMaterial.INSTANCE, Type.HELMET, props);
    ...
    public ModuleHostImpl createHost(ItemStack stack) {
        ModuleHostImpl host = new ModuleHostImpl(techLevel, ModuleCfg.chestpieceWidth(techLevel), ModuleCfg.chestpieceHeight(techLevel), "helmet", ModuleCfg.removeInvalidModules);
        host.addCategories(ModuleCategory.ARMOR, ModuleCategory.ARMOR_HEAD, ModuleCategory.ALL, ModuleCategory.CHESTPIECE);
    ...
    public EquippedItemModel getExtendedModel(LivingEntity entity, ItemStack stack, @Nullable EquipmentSlot slot, HumanoidModel<?> parentModel, boolean slim) {
        ...
        if (model == null || model_on_armor == null) {
            model = new ModularArmorModel<>(techLevel, false, EquipmentSlot.HEAD);
            model_on_armor = new ModularArmorModel<>(techLevel, true, EquipmentSlot.HEAD);
        }
